...
public class RoadMap {
	...
	public void addRoad(Road r){
		if(mapacarreteras.containsKey(r._id)||mapacruces.containsValue(r.getDest())==false||mapacruces.containsValue(r.getSrc())==false) {
	...
	public void addVehicle(Vehicle v) {
		if(mapavehiculos.containsKey(v._id)||auxitinerary(v)==false) {		
